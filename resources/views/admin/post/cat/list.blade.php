    ...
    <div class="row">
        ...
        <div class="col-4" style="padding-right: 0!important">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.post.cat.store') }}">
                        @csrf
        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped index-js">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.post.cat.edit', $categories[$i]['id']) }}"
                                        class="btn btn-success btn-sm rounded-0 text-white" type="button"
                                        data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ route('admin.post.cat.destroy', $categories[$i]['id']) }}"
                    ...
                    {!! get_pagging($paginate['page'], $paginate['total_page'], route('admin.post.cat.list', ['page' => ''])) !!}
                </div>
            </div>
        </div>
