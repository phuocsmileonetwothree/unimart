                ...
                <div class="card-body">
                    <table class="table table-striped index-js">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $index }}</td>
                                <td><img width="120px" height="80px" src="{{ url($slider->image->url) }}" alt=""></td>
                                <td class="text-primary">{{ $slider->title }}</td>
                                <td>
                                    <a href="{{ route('admin.slider.edit', $slider->id) }}" class="btn btn-success btn-sm rounded-0 text-white" type="button"
                                        data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ route('admin.slider.destroy', $slider->id) }}" class="btn btn-danger btn-sm rounded-0 text-white" type="button"
